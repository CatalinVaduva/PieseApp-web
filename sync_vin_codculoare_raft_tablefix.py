...
SQLITE_TABLE = "stoc_piese"  # dacă nu merge, pune aici numele real al tabelului din DB
SQLITE_CDP_COL = "cod_cdp"
SQLITE_RAFT_COL = "locatie_raft"
SQLITE_VIN_COL = "vin"
SQLITE_CULOARE_COL = "cod_culoare"
...
def fetch_sqlite_map():
    ...
    try:
        ...
        for t in tables:
            print("-", t[0])
        print("")
        print("Schimbă variabila SQLITE_TABLE din script cu numele corect al tabelului.")
        conn.close()
        raise
